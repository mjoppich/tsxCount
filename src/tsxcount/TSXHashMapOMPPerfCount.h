...
#ifndef TSXCOUNT_TSXHASHMAPOMPPERFCOUNT_H
#define TSXCOUNT_TSXHASHMAPOMPPERFCOUNT_H
...
class TSXHashMapOMPPerfCount : public TSXHashMapPerf {

public:

    TSXHashMapOMPPerfCount(uint8_t iL, uint32_t iStorageBits, uint16_t iK, uint8_t iThreads=2)
    ...
    {
        TSXHashMapPerf::print_stats();
        std::cerr << "TOTAL ABORTS " << iTotalAborts << std::endl;
    }
...
#endif //TSXCOUNT_TSXHASHMAPOMPPERFCOUNT_H